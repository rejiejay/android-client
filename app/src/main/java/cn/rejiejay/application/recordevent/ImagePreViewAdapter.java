...
public class ImagePreViewAdapter extends PagerAdapter {
    ...
    public ImagePreViewAdapter(Context context, List<String> imgList) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View itemView = getItemView(R.layout.recordevent_imagepreview);
        PhotoView imageView = (PhotoView) itemView.findViewById(R.id.image_preView_adapter);
