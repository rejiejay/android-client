 ...
 * =======================================================
 */
public class TaskDetailTimelineAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private LayoutInflater inflater;
    private List<TaskDetailTimelineData> traceList = new ArrayList<>();
    private static final int TYPE_TOP = 0x0000;
    private static final int TYPE_NORMAL= 0x0001;

    public TaskDetailTimelineAdapter(Context context, List<TaskDetailTimelineData> traceList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.task_detail_timeline, parent, false));
    }
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindHolder(TaskDetailTimelineData timeline) {
            tvAcceptTime.setText(timeline.getAcceptTime());
            tvAcceptStation.setText(timeline.getAcceptStation());
        }
    }
}
