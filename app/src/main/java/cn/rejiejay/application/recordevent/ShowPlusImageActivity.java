...
public class ShowPlusImageActivity {}
/**
 * 查看大图
public class ShowPlusImageActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recordevent_showplusimage);

        imgList = getIntent().getStringArrayListExtra("img_list"); // 第几张图片
        mPosition = getIntent().getIntExtra("position", 0); // 第几张图片
        initView();
    }
